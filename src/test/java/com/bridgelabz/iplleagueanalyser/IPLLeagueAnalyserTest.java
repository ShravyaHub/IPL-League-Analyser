...
public class IPLLeagueAnalyserTest {
    ...
    public static final String IPL_BATTING_FILE_PATH = "C:\\Users\\My PC\\Desktop\\Shravya\\MostRuns.csv";
    ...
    public void givenIPLBattingData_ShouldReturnNumberOfRecords() throws IPLAnalyserException {
        Assert.assertEquals(101, new IPLLeagueAnalyser().loadCSVBattingData(IPL_BATTING_FILE_PATH));
    }

    @Test
    public void givenIPLBattingData_ShouldReturnTopThreeBattingAverages() throws Exception {

        List<IPLMostRunsCSV> topBattingAverage = new IPLLeagueAnalyser().getTopBattingAverages(IPL_BATTING_FILE_PATH);
    ...
    public void givenIPLBattingData_ShouldReturnTopThreeStrikingRates() throws Exception {
        ...
        List<IPLMostRunsCSV> topStrikeRate = new IPLLeagueAnalyser().getTopStrikingRates(IPL_BATTING_FILE_PATH);
    ...
    public void givenIPLBattingData_ShouldReturnPlayerWithMax6s() throws Exception {
        ...
        Assert.assertEquals("Andre Russell", new IPLLeagueAnalyser().getPlayerWithMax6s(IPL_BATTING_FILE_PATH).get(0).getPlayer());
    }

    @Test
    public void givenIPLBattingData_ShouldReturnPlayerWithMax4s() throws Exception {

        Assert.assertEquals("Shikhar Dhawan", new IPLLeagueAnalyser().getPlayerWithMax4s(IPL_BATTING_FILE_PATH).get(0).player);
    }

    @Test
    public void givenIPLBattingData_ShouldReturnBestStrikingRatesWith6sAnd4s() throws IPLAnalyserException {
        Assert.assertEquals("Andre Russell", new IPLLeagueAnalyser().getPlayerWithBestStrikingRateWith6sAnd4s(IPL_BATTING_FILE_PATH).get(0).getPlayer());
    }
    ...
    public void givenIPLBattingData_ShouldReturnPlayerWithMaximumRunsAndBestAverage() throws IPLAnalyserException {
        Assert.assertEquals("David Warner", new IPLLeagueAnalyser().getPlayerWithMaximumRunsAndBestAverage(IPL_BATTING_FILE_PATH).get(0).getPlayer());
    }
    ...
    @Test
    public void givenIPLData_ShouldReturnBowlerWithMaximumWicketsAndBestAverages() {
    ...
    @Test
    public void givenIPLData_ShouldReturnPlayerWithMaximumHundredsAndBestBattingAverage() {
        Assert.assertEquals("David Warner", new IPLLeagueAnalyser().getPlayerWithMaximumHundredsAndBestBattingAverage().get(0).player);
    }

    @Test
    public void givenIPLData_ShouldReturnPlayerWhoHitZeroHundredsAndFiftiesButHaveBestBattingAverages() throws IPLAnalyserException {
        Assert.assertEquals("Marcus Stoinis", new IPLLeagueAnalyser().getPlayerWithZeroMaximumsAndFiftiesButBestBattingAverages(IPL_BATTING_FILE_PATH).get(0).player);
    }
